...
public class StringCompareTrigramTest extends TestCase {
    ...
    public void testStringCompareTrigram() throws Exception{
        ...
        List<ResultTuple5> list = dataSet.flatMap(new StringCompareTrigram((float)0.0)).collect();
        ...
        list = dataSet.flatMap(new StringCompareTrigram()).collect();
